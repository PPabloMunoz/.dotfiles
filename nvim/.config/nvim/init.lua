...
-- Custom: Do not create a new comment on a new line
...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          mappings = {
            ...
            -- normal mode mappings (when telescope prompt is in normal mode)
            n = {
              ['<C-j>'] = actions.move_selection_next,
              ['<C-k>'] = actions.move_selection_previous,
            },
      ...
      -- vim.keymap.set('n', '<leader><leader>', builtin.buffers, { desc = '[ ] Find existing buffers' }) -- DEFAULT CONFIG FOR <leader><leader>
